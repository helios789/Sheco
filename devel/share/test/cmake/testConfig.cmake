...
if("TRUE" STREQUAL "TRUE")
  set(test_SOURCE_PREFIX /home/helios789/catkin_ws/src/test)
  set(test_DEVEL_PREFIX /home/helios789/catkin_ws/devel)
  set(test_INSTALL_PREFIX "")
  set(test_PREFIX ${test_DEVEL_PREFIX})
else()
  set(test_SOURCE_PREFIX "")
  set(test_DEVEL_PREFIX "")
  set(test_INSTALL_PREFIX /home/helios789/catkin_ws/install)
...
if(NOT "/home/helios789/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/helios789/catkin_ws/src/test/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/helios789/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
